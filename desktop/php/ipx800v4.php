...
sendVarToJS('eqType', 'ipx800v4');
$eqLogics = eqLogic::byType('ipx800v4');
?>
    ...
    <div class="col-lg-2 col-md-3 col-sm-4">
        <div class="bs-sidebar">
            <ul id="ul_eqLogic" class="nav nav-list bs-sidenav">
                <a class="btn btn-default eqLogicAction" style="width : 100%;margin-top : 5px;margin-bottom: 5px;" data-action="add"><i class="fa fa-plus-circle"></i> {{Ajouter un ipx800}}</a>
...
foreach ($eqLogics as $eqLogic) {
	...
	echo "<center>";
	echo '<img src="plugins/ipx800v4/doc/images/ipx800v4_icon.png" height="105" width="95" />';
	echo "</center>";
